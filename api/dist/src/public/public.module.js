...
exports.PublicModule = PublicModule = __decorate([
    (0, common_1.Module)({
        controllers: [public_geo_controller_1.PublicGeoController, public_registration_controller_1.PublicRegistrationController, public_content_controller_1.PublicContentController],
    })
], PublicModule);
